...
mkdir fastq
mv atac_v1_pbmc_5k fastq/
```

### 2) Copy Snakemake files and other input files from this directory to atac_v1_pbmc_5k_fastqs directory. Run the following commands for benchmarking of single-cell quantification.
```
