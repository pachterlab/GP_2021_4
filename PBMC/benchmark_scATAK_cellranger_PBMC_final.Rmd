...
# Generate Figure2 panels A,B,C,D
library(cowplot)
plot_grid(figure2_p1, figure2_p4, labels=c("A", "B"), ncol=2) -> figure2_upper
plot_grid(figure2_p2, figure2_p3, labels=c("C", "D"), ncol=2) -> figure2_middle
plot_grid(figure2_upper, figure2_middle, nrow=2)              
...
figure2_p5<-VlnPlot(atac_pbmc_scatak, features = sig_genes, pt.size=0, ncol=2)
...
figure2_p6<-FeaturePlot(atac_pbmc_scatak, "MA0824.1_ID4", cols = c("white", "lightgrey", "red"))
figure2_p6
...
# Generate Figure2
```{r}
png("Figure2.png", width=800, height=900)
plot_grid(figure2_p1, figure2_p4, labels=c("A", "B"), ncol=2, label_size = 20) -> figure2_upper
plot_grid(figure2_p2, figure2_p3, labels=c("C", "D"), ncol=2, label_size = 20) -> figure2_middle
plot_grid(figure2_p5, figure2_p6, labels=c("E", "F"), ncol=2, label_size = 20) -> figure2_bottom
plot_grid(figure2_upper, figure2_middle, figure2_bottom, nrow=3)              
dev.off()
```
